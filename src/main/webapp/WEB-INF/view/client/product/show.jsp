                            ...
                            <div class="col-12 col-md-4">
                                <div class="row g-4">
                                    <div class="col-12" id="factoryFilter">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="checkbox" class="form-check-input" id="factory-5" value="LG">
                                            <label class="form-check-label" for="factory-5">LG</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input type="checkbox" class="form-check-input" id="factory-6" value="ACER">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="radio" name="radio-sort" class="form-check-input" id="sort-1"
                                                value="gia-tang-dan">
                                            <label class="form-check-label" for="sort-1">Giá tăng dần</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input type="radio" name="radio-sort" class="form-check-input" id="sort-2"
                                                value="gia-giam-dan">
                                            <label class="form-check-label" for="sort-2">Giá giảm dần</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input type="radio" name="radio-sort" class="form-check-input" id="sort-3"
                                                value="khong-sap-xep" checked>
                                            <label class="form-check-label" for="sort-3">Không sắp xếp</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <button id="btnFilter"
                                            class="btn border-secondary rounded-pill px-4 py-3 text-primary text-uppercase mb-4">LỌC
                                            SẢN PHẨM</button>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="pagination d-flex justify-content-center mt-5">
                                            ...
                                            <c:forEach begin="0" end="${totalPages-1}" varStatus="status">
                                                <li class="page-item"><a
                                                        class="page-link ${currentPage eq (status.index + 1) ? 'active' : ''}"
                                                        href="/products?page=${status.index + 1}${queryString}">${status.index
                                                        + 1}</a></li>
                                            </c:forEach>
