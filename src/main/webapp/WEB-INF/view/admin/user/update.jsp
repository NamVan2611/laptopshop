        ...
        <div class="container-fluid px-4 py-4">
            ...
            <div class="form-header">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    <div>
                        <h2 class="mb-1"><i class="bi bi-pencil-square me-2"></i>Update User</h2>
                        <p class="mb-0 opacity-75">Edit user information - ID: #${newUser.id}</p>
                    </div>
                        ...
                        <form:form method="post" action="/admin/user/update" modelAttribute="newUser"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <form:select class="form-select" path="role.name">
                                    <option value="USER" ${newUser.role.name == 'USER' ? 'selected' : ''}>User</option>
                                    <option value="ADMIN" ${newUser.role.name == 'ADMIN' ? 'selected' : ''}>Administrator</option>
                                </form:select>
                            </div>
                            ...
                            <div class="form-group col-12">
                                <div class="avatar-preview-container">
                                    ...
                                    <div id="previewPlaceholder" class="text-muted">
                                        ...
                                        <p class="mt-2">Current avatar or new avatar preview will appear here</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-12">
                                <div class="d-flex gap-2 justify-content-end">
                                    <a href="/admin/user/${newUser.id}" class="btn btn-secondary">
